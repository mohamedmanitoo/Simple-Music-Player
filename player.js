...
songIndex = 0;
songs = ['./assets/music/1.mp3', './assets/music/2.mp3']; // object storing paths for audio objects
...
songArtists = ['1', '2']; // object storing track artists
songTitles = ["1", "2"]; // object storing track titles
